"""0365: migawka zakończenia i powrót po przerwie mają lustro w entrypoincie.
...
MIGRATION = (
    BACKEND / "alembic" / "versions" / "0365_contract_termination_reversal.py"
).read_text()
...
def test_migration_chains_after_0363():
    assert 'revision = "0365_contract_termination_reversal"' in MIGRATION
