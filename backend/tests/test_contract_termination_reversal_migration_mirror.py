"""0355: migawka zakończenia i powrót po przerwie mają lustro w entrypoincie.
...
MIGRATION = (
    BACKEND / "alembic" / "versions" / "0355_contract_termination_reversal.py"
).read_text()
...
def test_migration_chains_after_0354():
    assert 'revision = "0355_contract_termination_reversal"' in MIGRATION
