"""0325: kolumny przełącznika „prowadzona w NEXUSIE" mają lustro w entrypoincie.
...
MIGRATION = BACKEND / "alembic" / "versions" / "0325_jobs_managed_in_nexus.py"
...
def test_migration_chains_after_candidate_auto_match():
    module = _migration_module()
    assert module.revision == "0325_jobs_managed_in_nexus"
