...
_ENUM_STATEMENTS = [
    ...
    # 0374: praktykant — „Telefony na dziś”.
    ...
    # 0374: decyzja o końcu programu praktykanta.
...
_COLUMN_STATEMENTS = [
    ...
    *_B2B_REGISTER_DDL,
    ...
    # 0373: waluta sprzed zmiany stawki — listener zapisuje ją przy każdej
    ...
    # 0381: pozycja faktury Nordei zapisana przy zamówieniu
...
EXCEPTION WHEN duplicate_object THEN NULL; END $$""",
    ...
    # 0374: praktykant — rola w CHECK-ach RBAC i wyłączności (przed seedem
...
_DATA_STATEMENTS = [
    *_B2B_DOCUMENTS_BACKFILL,
    ...
    # 0374: praktykant nie ma sekcji ani akcji. Wiersze `none` dopisywane także
...
# Trzy nazwy rekrutacji (0380, 25.09.2026) — jednorazowo: tytuł dla rekrutera
