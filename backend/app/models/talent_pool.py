...
class TalentPool(Base):
    ...
    memberships = relationship("TalentPoolMembership", back_populates="pool", cascade="all, delete-orphan")
...
class TalentPoolMembership(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, index=True)
    talent_pool_id: Mapped[int] = mapped_column(ForeignKey("talent_pools.id"), nullable=False, index=True)
