...
class Candidate(Base, TimestampMixin):
    ...
    notice_period: Mapped[Optional[int]] = mapped_column(Integer)  # value (interpreted via notice_period_unit; NULL unit = legacy days)
    notice_period_unit: Mapped[Optional[str]] = mapped_column(String(20))  # "days" | "weeks" | "months"
