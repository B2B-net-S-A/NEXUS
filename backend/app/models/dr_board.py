...
class DrBoardMonthlyReport(Base):
    ...
    report_month: Mapped[date] = mapped_column(Date, nullable=False, unique=True, index=True)
    revenue: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=0, server_default="0")
    consultant_costs: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=0, server_default="0")
    other_costs: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=0, server_default="0")
    active_consultants: Mapped[int] = mapped_column(Integer, default=0, server_default="0")
    ...
    avg_margin_per_hour: Mapped[Decimal] = mapped_column(Numeric(10, 2), default=0, server_default="0")
    hit_ratio: Mapped[Decimal] = mapped_column(Numeric(5, 2), default=0, server_default="0")
