...
_RULES: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    (
        "security_quality",
        (
            r"\bqa\b", r"quality assurance", r"tester", r"\btest\b",
            r"pentest", r"penetration", r"\bsecurity\b", r"\bsoc\b",
            r"\bsiem\b", r"\biam\b", r"vulnerability", r"appsec", r"owasp",
        ),
    ),
    ...
    (
        "data_ai",
        (
            r"data scientist", r"data science", r"data engineer",
            r"data architect", r"data analyst", r"big data", r"hadoop",
            r"\bml\b", r"mlops", r"machine learning", r"deep learning",
            r"\bai\b", r"\bnlp\b", r"\bllm\b",
        ),
    ),
    ...
    (
        "management_delivery",
        (
            r"\banalyst\b", r"\bpm\b", r"\bpmo\b", r"product owner",
            r"product manager", r"\bproduct\b", r"project", r"scrum",
            r"agile", r"\brte\b", r"release train", r"\bmanager\b",
            r"transition", r"rollout", r"\bprogram\b", r"\brisk\b",
            r"\bgrc\b", r"compliance", r"\bdora\b", r"delivery", r"coach",
        ),
    ),
    ...
    (
        ...
        (
            r"devops", r"\bsre\b", r"\bcloud\b", r"infrastructure",
            r"\binfra\b", r"platform engineer", r"network", r"\bnoc\b",
            r"linux", r"windows", r"virtualization", r"helpdesk",
            r"service desk", r"\bdba\b", r"mainframe", r"sysadmin",
            r"kubernetes",
        ),
    ),
    ...
    (
        ...
        (
            r"developer", r"\bdev\b", r"backend", r"frontend",
            r"full[\s-]?stack", r"\bjava\b", r"javascript", r"typescript",
            r"python", r"\bnode\b", r"node\.js", r"\.net\b", r"dotnet",
            r"\bc#", r"csharp", r"\bphp\b", r"\breact\b", r"angular",
            r"\bvue\b", r"android", r"\bios\b", r"mobile", r"\bgo\b",
            r"golang", r"cobol", r"abap", r"pega", r"low[\s-]?code",
            r"power\s*apps", r"power platform", r"ux\s*/\s*ui", r"c/c\+\+",
            r"\bc\+\+", r"\brpa\b", r"\bsap\b", r"\berp\b", r"architect",
        ),
    ),
)
