...
* **migawka** (``contract_termination_snapshots``, od 0355) — zapisana przy
  zakończeniu, dokładna;
* **historia** — zakończenia sprzed 0355. Datę końca przypisania bierzemy
...
async def _plan_from_history(db: AsyncSession, plan: ReversalPlan) -> None:
    """Zakończenie sprzed 0355: stan „przed" z historii zmian przypisania."""
