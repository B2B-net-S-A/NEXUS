...
class EventRef:
    ...
    # 0358 — prep założony z NEXUSA (Teams): numer, transkrypt, ocena.
...
def compute_steps(
    ...
    # 3–4. Prep i Prep 2 — oba wymagane (0358); po rozmowie już się nie wydarzą.
...
# Brak prepu tuż przed rozmową u klienta jest pilny (0358).
...
def compute_todos(
    ...
    *,
    ...
    if iv is not None and iv.start > now:
        ...
        # Najpierw Prep 1 — dwa zadania naraz to szum; Prep 2 zawsze (0358).
        if first is None:
...
async def load_snapshots(
    ...
    *,
    ...
    # 0358: stan prepów z NEXUSA (numer, transkrypt, ocena) — jedno zapytanie.
