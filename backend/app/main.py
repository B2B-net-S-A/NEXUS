...
from app.api import integrations_companies as integrations_companies_api
...
async def lifespan(app: FastAPI):
    ...
    app.state.background_tasks = {
        ...
        "m365_cv_parse": asyncio.create_task(m365_cv_parse_loop()),
        ...
        # 0358: kolejka publikacji na portalach — kończy się przed pętlą,
...
# Multiposting (0358): szkielet Pracuj.pl + JustJoinIT za flagami OFF.
...
# klienta OAuth, odczyt w Insights → Integracje. Migracja 0314.
app.include_router(
...
app.include_router(
    candidate_conflicts_api.router, prefix="/api", tags=["candidate-conflicts"]
)
...
app.include_router(
    integrations_companies_api.router,
    prefix="/api/integrations",
    tags=["integrations"],
)
...
async def api_health_check():
    ...
    # 0358: multiposting — informacyjne, nie zmienia `status`. Dziś wszystkie
...
async def api_health_deep_check():
    ...
    core_checks = [
        ...
        # 0356: dedup maila potwierdzenia aplikacji. Brak tabeli nie wywraca
