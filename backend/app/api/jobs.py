...
async def create_job(
    ...
    # 0378: numer u klienta i tytuł dla rekrutera. Jawny tytuł = ręczny
...
async def update_job(
    ...
    # 0378: ręczny tytuł dla rekrutera wyłącza automat, pusty go przywraca.
...
async def _save_champion_profile(
    ...
    *,
    ...
    # 0378: tytuł dla rekrutera idzie za Championem, dopóki nikt go nie zmienił.
    from app.services.job_working_title import refresh_working_title
