...
def _stage_response(
    ...
    *,
    ...
    return {
        ...
        # Snapshot stawki z ruchu na „Zweryfikowany" (migracja 0056).
...
async def move_candidate(
    ...
    if is_terminal_target and not user_can_terminal_transition(current_user):
        raise HTTPException(
            ...
            detail=(
                ...
                "admin, head_of_recruitment, delivery_lead, talent_community_manager, "
                "tac, recruiter lub finance."
            ),
        )
    ...
    if legacy_enum == PipelineStage.verified and not user_can_edit_rates(current_user):
        raise HTTPException(
            ...
            detail=(
                ...
                "roli admin, head_of_recruitment, delivery_lead, tac, recruiter "
                "lub finance."
            ),
        )
    ...
    if legacy_enum == PipelineStage.verified and job.salary_max is not None:
