...
class CycleStep(BaseModel):
    ...
    # 0364: jakość odbytego prepu — good | ok | weak | unrecorded | pending.
...
class AgendaEntry(PairInfo):
    ...
    # 0364: prep założony z NEXUSA (Teams) i jego ocena po spotkaniu.
...
class TodoEntry(PairInfo):
    ...
    event_id: Optional[int] = None
    slot_request_id: Optional[int] = None
    # 0364: brak prepu na dobę przed rozmową u klienta.
    urgent: bool = False
