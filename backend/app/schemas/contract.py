...
# Rozwiązanie umowy B2B (0364): wypowiedzenie / porozumienie stron; stronę,
...
class ContractResponse(BaseModel):
    ...
    termination_lessons: Optional[str] = None
    terminated_at: Optional[date] = None
    # Rozwiązanie umowy B2B z okna „Zakończ współpracę" (0364).
...
class AgreementTerminationPayload(BaseModel):
    """„Rozwiązanie umowy" z okna „Zakończ współpracę" (0364).
