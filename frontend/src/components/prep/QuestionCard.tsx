...
export function QuestionCard({
 ...
 return (
 <Card variant="default" size="md" className="print:shadow-none print:border-border">
 ...
 <div className="mt-3 p-3 bg-primary/10 rounded-md print:border print:border-border print:bg-transparent">
