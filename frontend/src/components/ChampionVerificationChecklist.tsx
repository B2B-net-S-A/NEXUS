...
/**
 * Two-sided verification checklist for the Champion Profile.
 *
 ...
 * Soft signal only: nothing here blocks publishing a job. Stamps (who/when)
 * are set server-side.
 */
...
export function ChampionVerificationChecklist({
  ...
  const [openForm, setOpenForm] = useState<"client" | "consultant" | null>(null);
