...
>(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn("fixed inset-0 z-40 bg-card/50 backdrop-blur-[2px]","data-[state=open]:animate-fadeIn",
 className
 )}
 {...props}
 />
...
>(({ side ="right", size ="md", className, children, hideClose, ...props }, ref) => (
 ...
 ref={ref}
 className={cn("fixed z-50 flex flex-col bg-card text-foreground","border-border shadow-md",
 ...
 className={cn("absolute right-4 top-4 rounded-md p-1","text-muted-foreground hover:text-foreground","hover:bg-primary/10 transition-colors","focus:outline-none"
 )}
 >
 <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn("font-semibold text-lg font-bold tracking-[-0.01em] text-foreground",
 className
 )}
 {...props}
 />
