...
>(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn("fixed inset-0 z-50 bg-card/60 backdrop-blur-[2px]","data-[state=open]:animate-fadeIn",
 className
 )}
 {...props}
 />
...
>(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn("font-semibold text-xl font-bold tracking-[-0.01em] text-foreground",
 className
 )}
 {...props}
 />
