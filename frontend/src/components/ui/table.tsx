...
>(({ className, ...props }, ref) => (
 <thead
 ref={ref}
 className={cn("bg-background border-b border-border","[&_tr]:border-b-0",
 className
 )}
 {...props}
 />
...
>(({ className, ...props }, ref) => (
 <tfoot
 ref={ref}
 className={cn("bg-background border-t border-border font-medium",
 className
 )}
 {...props}
 />
...
>(({ className, sortable, ...props }, ref) => {
 ...
 <th
 ref={ref}
 className={cn("text-left align-middle font-semibold","text-[10px] uppercase tracking-[0.08em] text-muted-foreground",
...
>(({ className, ...props }, ref) => {
 ...
 <td
 ref={ref}
 className={cn("align-middle text-foreground",
 densityCellClass[density],
 className
 )}
 {...props}
