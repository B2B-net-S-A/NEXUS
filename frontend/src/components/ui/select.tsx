...
>(({ className, children, invalid, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      "flex w-full h-10 items-center justify-between gap-2 px-3 py-2 text-sm",
      ...
      "data-[placeholder]:text-[hsl(var(--text-muted))]",
      invalid && "border-[hsl(var(--accent))]",
      className
    )}
    {...props}
  >
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-v2-m bg-[hsl(var(--bg-surface))] text-[hsl(var(--text-body))]",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-xs font-semibold uppercase tracking-[0.12em] text-[hsl(var(--text-muted))]",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-v2-s py-1.5 pl-8 pr-2 text-sm outline-none",
      "focus:bg-[hsl(var(--accent-soft))] focus:text-[hsl(var(--text-title))]",
