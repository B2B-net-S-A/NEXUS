  ...
  return (
    <div className="flex items-start justify-between gap-3 flex-wrap">
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-3">
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            {collaborators.length === 0 ? (
              <span className="text-xs text-[hsl(var(--text-muted))]">Brak.</span>
            ) : (
              collaborators.map((c) => (
                <span
                  key={c.id}
                  className="inline-flex items-center gap-1 pl-1 pr-2 h-6 rounded-full bg-[hsl(var(--bg-surface))] border border-[hsl(var(--border-subtle))] text-[11px]"
                ...
                >
                  ...
                  {canManageCollaborators ? (
                    <button
                      ...
                      className="text-[hsl(var(--text-muted))] hover:text-[hsl(var(--accent))]"
        ...
        {error ? (
          <div className="mt-2 text-xs text-[hsl(var(--accent))]">{error}</div>
        ) : null}
      </div>
...
function AddCollaboratorInner({
  ...
  return (
    <div className="space-y-2">
      ...
      {error ? (
        <div className="text-xs text-[hsl(var(--accent))]">{error}</div>
      ) : null}
