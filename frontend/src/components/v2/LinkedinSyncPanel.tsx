  ...
  return (
    <section>
      <div className="flex items-center justify-between gap-2 mb-3 flex-wrap">
        <h3 className="text-xs font-semibold uppercase tracking-[0.12em] text-[hsl(var(--text-muted))] flex items-center gap-2">
      ...
      <div className="rounded-v2-m border border-[hsl(var(--border-subtle))] bg-[hsl(var(--bg-canvas))]/40 p-3 space-y-3">
        {!hasLinkedin && (
        ...
        {status === "ok" && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
            <div>
              ...
              <div className="text-[hsl(var(--text-title))] mt-0.5">
        ...
        {changeSnapshots.length > 0 && (
          <div>
            <div className="text-[10px] font-semibold uppercase tracking-[0.12em] text-[hsl(var(--text-muted))] mb-1">
              Historia zmian pracodawcy
            </div>
            <ul className="space-y-1 text-sm">
              {changeSnapshots.map((s) => (
                <li key={s.id} className="text-[hsl(var(--text-body))]">
