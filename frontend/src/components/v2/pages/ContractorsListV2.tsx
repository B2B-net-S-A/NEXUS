...
export function ContractorsListV2() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-4 p-6">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? "border-[hsl(var(--accent))] text-[hsl(var(--text-title))]"
                  : "border-transparent text-[hsl(var(--text-muted))] hover:text-[hsl(var(--text-body))]"
              )}
            >
              {TAB_LABELS[t]}
        ...
        <TableBody>
          {isLoading ? (
            <TableRow>
              <TableCell
                colSpan={8}
                className="text-center py-10 text-[hsl(var(--text-muted))]"
              >
                Ładowanie…
              </TableCell>
            </TableRow>
            ...
            <TableRow>
              <TableCell colSpan={8} className="text-center py-10">
                <UserCog className="h-10 w-10 mx-auto text-[hsl(var(--text-muted))] mb-2 opacity-40" />
      ...
      <div className="text-xs text-[hsl(var(--text-muted))] pt-2">
