      ...
      <SheetContent side="right" size="md">
        <SheetHeader>
          <div className="flex items-center gap-2">
            <UserCog className="h-4 w-4 text-[hsl(var(--accent))]" />
            ...
            <SheetBody>
              <div className="space-y-4">
                ...
                <div>
                  <label
                    htmlFor="user_id"
                    className="block text-xs uppercase tracking-wider text-[hsl(var(--text-muted))] mb-1"
                  >
                    Nowy właściciel
                  </label>
                ...
                {error ? (
                  <div
                    role="alert"
                    className="text-sm text-[hsl(var(--accent))] bg-[hsl(var(--accent-soft))] px-3 py-2 rounded-v2-s"
                  >
                    {error}
                  </div>
                ) : null}
