      ...
      default:
        return (
          <textarea
            ...
            className="w-full min-h-[80px] px-3 py-2 text-sm bg-[hsl(var(--bg-surface))] text-[hsl(var(--text-body))] border border-[hsl(var(--border-subtle))] rounded-v2-m placeholder:text-[hsl(var(--text-muted))] focus:outline-none focus:border-[hsl(var(--accent))]"
