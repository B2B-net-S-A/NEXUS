      ...
      <DialogContent size="2xl" className="flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={onSubmit} className="contents">
          <DialogBody className="space-y-4 flex-1">
            <div>
              <label className="block text-sm font-medium text-[hsl(var(--text-title))] mb-1.5">
                Tytuł
              </label>
              <Input
              ...
              />
              {errors.title && (
                <p id="title-error" className="text-xs text-[hsl(var(--accent-strong))] mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="space-y-2">
                <label className="block text-sm font-medium text-[hsl(var(--text-title))]">
                  Treść (Markdown)
                </label>
                <Textarea
                  rows={16}
                ...
                />
                {errors.content && (
                  <p id="content-error" className="text-xs text-[hsl(var(--accent-strong))]">
              ...
              <div className="space-y-2">
                <span className="block text-sm font-medium text-[hsl(var(--text-title))]">
                  Podgląd
                </span>
                <div
                  className="rounded-v2-m border border-[hsl(var(--border-subtle))] bg-[hsl(var(--bg-canvas))] p-4 min-h-[280px] max-h-[400px] overflow-y-auto prose prose-sm max-w-none prose-headings:font-display prose-headings:text-[hsl(var(--text-title))] prose-a:text-[hsl(var(--accent))]"
                  aria-live="polite"
                >
                  {previewContent ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="flex items-end">
                <label className="inline-flex items-center gap-2 text-sm">
                  <input
                    type="checkbox"
                    className="h-4 w-4 rounded border-[hsl(var(--border-subtle))] accent-[hsl(var(--accent))]"
            ...
            {apiError && (
              <p className="text-sm text-[hsl(var(--accent-strong))]">{apiError}</p>
            )}
          </DialogBody>
