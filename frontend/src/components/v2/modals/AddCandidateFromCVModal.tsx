...
function ConfidenceRow({
 ...
 return (
 <div
 className={cn("flex items-start justify-between gap-3 py-1.5 text-sm",
 low &&"rounded-md bg-amber-50 border border-amber-200 px-2 -mx-2"
 )}
 >
...
export function AddCandidateFromCVModal({ open, onOpenChange, onAdded }: Props) {
 ...
 className="flex items-center justify-between rounded-lg border border-border p-3 text-sm hover:bg-primary/10 hover:border-primary"
 >
 <div>
