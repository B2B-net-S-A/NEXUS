              ...
              <div className="space-y-5">
                {questions.map((q, i) => {
                  ...
                  return (
                    <div
                      key={q.id}
                      className="rounded-v2-m border border-[hsl(var(--border-subtle))] bg-[hsl(var(--bg-canvas))]/40 p-4 space-y-3"
                    >
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-semibold text-[hsl(var(--text-title))]">
                            {q.question}
                          </p>
                          {q.ideal_answer && (
                            <p className="text-xs text-[hsl(var(--text-muted))] mt-1 italic">
                ...
                <div className="pt-2">
                  ...
                  >
                    {FIT_OPTIONS.map((opt) => (
                      <label
                        key={opt.value}
                        className="flex items-start gap-2 cursor-pointer rounded-v2-s p-2 hover:bg-[hsl(var(--accent-soft))]"
                      >
