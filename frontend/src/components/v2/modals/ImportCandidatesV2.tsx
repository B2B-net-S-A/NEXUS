      ...
      <DialogContent size="md">
        {result ? (
          <>
            ...
            <DialogBody>
              <dl className="grid grid-cols-3 gap-3 text-sm">
                <div className="rounded-v2-m bg-[hsl(var(--accent-soft))] p-3">
                  <dt className="text-xs text-[hsl(var(--text-muted))] uppercase tracking-wider">
                    Zaimportowano
                  </dt>
                  <dd className="text-2xl font-bold text-[hsl(var(--accent))] font-mono">
                    {result.imported ?? 0}
                  </dd>
                </div>
                <div className="rounded-v2-m bg-amber-50 border border-amber-200 p-3">
                ...
                <div className="rounded-v2-m bg-[hsl(var(--border-subtle))]/40 p-3">
                  <dt className="text-xs text-[hsl(var(--text-muted))] uppercase tracking-wider">
                    Wierszy łącznie
                  </dt>
                  <dd className="text-2xl font-bold text-[hsl(var(--text-title))] font-mono">
                    {result.total_rows ?? 0}
                  </dd>
                </div>
              </dl>
                ...
                <div className="mt-4">
                  ...
                  <div className="space-y-1 max-h-40 overflow-y-auto text-xs">
                    {result.errors.slice(0, 20).map((e, i) => (
                      <div
                        key={i}
                        className="flex items-start gap-1.5 text-[hsl(var(--accent))]"
                      >
          ...
          <>
            <DialogHeader>
              <div className="flex items-center gap-2">
                <FileUp className="h-4 w-4 text-[hsl(var(--accent))]" />
            ...
            <DialogBody>
              ...
              >
                <Upload className="h-10 w-10 mx-auto mb-3 text-[hsl(var(--text-muted))]" />
                {file ? (
                  <div>
