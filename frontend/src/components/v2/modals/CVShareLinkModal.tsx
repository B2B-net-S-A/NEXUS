    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent size="lg" className="p-0">
        <div className="px-5 py-4 border-b border-[hsl(var(--border-subtle))]">
          ...
          <div className="text-sm font-medium text-[hsl(var(--text-title))] mt-0.5">
            {candidateName}
          </div>
        </div>
        ...
        <div className="p-5 space-y-4">
          {!token ? (
            <>
              ...
              {errorMsg ? (
                <div className="rounded-v2-m border border-red-200 bg-red-50 dark:border-red-900 dark:bg-red-950 px-3 py-2 text-xs text-red-700 dark:text-red-300 flex items-start gap-2">
            ...
            <>
              <div>
                ...
                {expiresLabel ? (
                  <p className="text-[11px] text-[hsl(var(--text-muted))] mt-1.5">
                    Aktywny do {expiresLabel}
                  </p>
                ) : null}
              </div>

              <div className="flex items-center justify-between gap-2 pt-2 border-t border-[hsl(var(--border-subtle))]">
                <Button
                  variant="ghost"
                  size="sm"
