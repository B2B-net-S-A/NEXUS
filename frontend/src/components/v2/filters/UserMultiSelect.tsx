 ...
 * Distinct from `AddedByMultiSelect` which uses an admin-only endpoint with
 * a sentinel "system import" option.
 */
              ...
              <>
                ...
                <div className="flex items-center justify-between px-2 py-1.5 text-xs">
                  <button
                    type="button"
                    onClick={selectAll}
                    className="text-[hsl(var(--text-muted))] hover:text-[hsl(var(--text))] hover:underline"
                  >
                    Zaznacz wszystkich
                  </button>
                  <button
                    type="button"
                    onClick={clear}
                    className="text-[hsl(var(--text-muted))] hover:text-[hsl(var(--text))] hover:underline disabled:opacity-50"
