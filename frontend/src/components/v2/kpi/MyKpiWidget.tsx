    ...
    return (
      ...
      >
        <header className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-sm font-semibold text-[hsl(var(--text-title))]">
            Twoje KPI
          </h2>
        </header>
  ...
  return (
    ...
    >
      <button
        type="button"
        className={cn(
          "flex items-center gap-2 h-9 px-3 rounded-v2-m",
          "border border-[hsl(var(--border-subtle))]",
          "bg-[hsl(var(--bg-canvas))]/60 hover:bg-[hsl(var(--bg-canvas))]",
          "text-xs text-[hsl(var(--text-muted))] transition-colors",
        )}
        aria-label="Moje KPI"
      >
        <Target className="h-3.5 w-3.5 text-[hsl(var(--accent))] shrink-0" />
        ...
        <span className="lg:hidden font-medium text-[hsl(var(--text-title))]">
          KPI
        </span>
      </button>
      ...
      {hovered && (
        <div
          className={cn(
            ...
            "rounded-v2-m border border-[hsl(var(--border-subtle))]",
            "bg-[hsl(var(--bg-surface))] shadow-v2-md",
          )}
          role="tooltip"
        >
          <div className="text-xs font-semibold text-[hsl(var(--text-title))] mb-2">
