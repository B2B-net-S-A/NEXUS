  ...
  return (
    <TooltipProvider delayDuration={200}>
      <div
        ...
        className={cn(
          "flex items-center justify-between gap-3 rounded-v2-m border border-[hsl(var(--border-subtle))] bg-[hsl(var(--bg-surface))] px-3 py-2 text-sm",
          className,
        )}
      >
        <Tooltip>
        ...
        <div
          className="text-xs tabular-nums text-[hsl(var(--text-muted))]"
          aria-live="polite"
        >
          {total > 0 ? (
            <>
