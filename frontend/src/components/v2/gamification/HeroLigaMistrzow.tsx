    ...
    <div className="flex flex-col items-center">
      ...
      {entry ? (
        <div className="text-center mb-3 flex flex-col items-center">
          ...
          <div className="mt-2">
            <span className="text-amber-300 font-display font-extrabold text-2xl">
              {entry.metric_value}
            </span>
            {metricUnit && (
      ...
      <div
        className={cn(
          "w-full rounded-t-lg bg-gradient-to-b shadow-lg flex items-end justify-center pb-3",
          style.bg,
          style.height,
...
export function HeroLigaMistrzow({
  ...
  return (
    <div className="rounded-v2-l bg-gradient-to-br from-indigo-700 via-purple-700 to-purple-900 p-6 shadow-v2-l text-white">
      {/* Header */}
      <div className="flex items-start justify-between mb-6 flex-wrap gap-3">
        <div className="flex items-center gap-3">
          <div className="h-12 w-12 rounded-v2-m bg-amber-500 flex items-center justify-center shadow-lg">
        ...
        <div className="flex flex-col items-end">
          ...
          <div className="mt-2 w-40 h-1.5 rounded-full bg-white/10 overflow-hidden">
            <div
      ...
      <div className="grid grid-cols-3 gap-2 md:gap-3 mt-4 max-w-2xl mx-auto">
        {[1, 2, 3].map((rank) => {
          ...
          return (
            <div
              key={rank}
              className="rounded-v2-s bg-white/5 border border-white/10 px-3 py-2 text-center"
            >
              ...
              <div className="text-amber-300 font-display font-extrabold text-lg leading-tight">
      ...
      {/* Points formula */}
      {pointsFormula && (
        <div className="mt-5 rounded-v2-s bg-white/5 border border-white/10 px-4 py-2.5 flex items-center gap-4 flex-wrap">
      ...
      {/* Requirement */}
      {requirement && (
        <div className="mt-3 rounded-v2-s bg-amber-500/10 border border-amber-400/30 px-4 py-2.5">
      ...
      {fullRanking && fullRanking.length > 3 && (
        <details className="mt-4 rounded-v2-s bg-white/5 border border-white/10">
