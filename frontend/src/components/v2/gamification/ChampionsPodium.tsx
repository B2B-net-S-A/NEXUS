...
export function ChampionsPodium({
  ...
  if (!top3.length) {
    return (
      <Card>
        <div className="flex flex-col items-center justify-center py-10 text-[hsl(var(--text-muted))]">
  ...
  return (
    <Card>
      <div className="flex items-start justify-between mb-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-display text-lg font-bold text-[hsl(var(--text-title))]">
              {title}
            </h3>
          </div>
          {subtitle && (
        ...
        {[2, 1, 3].map((rank) => {
          ...
          return (
            <div key={rank} className="flex flex-col items-center">
              <div
                className={cn(
                  "w-full rounded-v2-m border-2 p-3 flex flex-col items-center justify-end transition-all",
                  style.height,
                  style.bg,
                  isMe ? "border-[hsl(var(--accent))] ring-2 ring-[hsl(var(--accent-soft))]" : style.border,
                )}
              >
                ...
                <p
                  className={cn(
                    "text-sm font-bold text-center line-clamp-2",
                ...
                {entry && (
                  <>
                    ...
                    <p className="text-[10px] uppercase tracking-wide text-[hsl(var(--text-muted))]">
                      {metricLabel}
                    </p>
              ...
              <span className="mt-2 text-[11px] font-bold text-[hsl(var(--text-muted))]">
                #{rank}
              </span>
            </div>
          )
      ...
      {targetPct !== null && targetPct !== undefined && (
        <p className="mt-3 text-[10px] text-center text-[hsl(var(--text-muted))]">
