  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="flex flex-wrap items-end gap-3 p-3 bg-[hsl(var(--accent-soft))]/40 rounded-v2-m">
          <div className="flex-1 min-w-[200px]">
            <label className="text-[11px] font-semibold uppercase tracking-wide text-[hsl(var(--text-muted))] block mb-1">
              Użytkownik
            </label>
            <select
              className="w-full h-10 px-3 border border-[hsl(var(--border-subtle))] rounded-v2-m bg-[hsl(var(--bg-surface))]"
              value={form.user_id}
          ...
          <table className="w-full text-sm">
            <thead className="border-b border-[hsl(var(--border-subtle))]">
              <tr>
                ...
                <th className="text-right text-[11px] font-semibold uppercase tracking-wide text-[hsl(var(--text-muted))] px-3 py-2">
                  Akcje
                </th>
              </tr>
            </thead>
              ...
              {(summary?.delivery_leads ?? []).map((row) =>
                row.tacs.length === 0 ? (
                  <tr key={row.delivery_lead.id}>
                    ...
                    <td colSpan={3} className="px-3 py-2 text-xs text-[hsl(var(--text-muted))] italic">
                      brak TAC-ów
                    </td>
                  </tr>
                ) : (
                    ...
                    <tr key={`${row.delivery_lead.id}-${tac.user_id}`}>
                      {tIdx === 0 && (
                        <td
                          ...
                          className="px-3 py-2 font-semibold align-top border-r border-[hsl(var(--border-subtle))]"
                        >
                          {row.delivery_lead.name}
                        </td>
                      )}
