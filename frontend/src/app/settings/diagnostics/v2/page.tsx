    ...
    >
      <TooltipProvider delayDuration={200}>
        <div className="mx-auto max-w-7xl p-8 space-y-14">
          ...
          <footer className="pt-8 border-t border-[hsl(var(--border-subtle))] text-xs text-[hsl(var(--text-muted))]">
...
function SubRow({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="space-y-2">
      <h3 className="text-xs font-semibold uppercase tracking-[0.18em] text-[hsl(var(--text-muted))]">
        {label}
      </h3>
      <div className="flex flex-wrap items-center gap-3 bg-[hsl(var(--bg-surface))] p-4 rounded-v2-m border border-[hsl(var(--border-subtle))]">
        {children}
      </div>
    </div>
  );
...
function ColorsSection() {
  return (
    <Section num={1} title="Colors & tokens">
      ...
      <div className="pt-2">
        <h3 className="text-xs font-semibold uppercase tracking-[0.18em] text-[hsl(var(--text-muted))] mb-3">
          Semantic aliases
        </h3>
...
function SwatchGroup({ title, swatches }: { title: string; swatches: [string, string][] }) {
  return (
    <div>
      <h3 className="text-xs font-semibold uppercase tracking-[0.18em] text-[hsl(var(--text-muted))] mb-2">
        {title}
      </h3>
...
function TypographySection() {
  return (
    <Section num={2} title="Typography">
      <div className="space-y-3 bg-[hsl(var(--bg-surface))] p-6 rounded-v2-m border border-[hsl(var(--border-subtle))]">
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[hsl(var(--accent))]">
    ...
    <Section num={5} title="Checkbox · Radio · Switch">
      <SubRow label="Checkbox">
        <div className="flex flex-col gap-3">
          ...
          <label className="inline-flex items-center gap-2 text-sm text-[hsl(var(--text-muted))] cursor-not-allowed">
            <Checkbox disabled />
            Disabled
          </label>
        </div>
...
function SeparatorKbdSection() {
  return (
    <Section num={8} title="Separator · Kbd">
      <div className="bg-[hsl(var(--bg-surface))] p-4 rounded-v2-m border border-[hsl(var(--border-subtle))] space-y-3">
...
function TabsSection() {
  return (
    <Section num={9} title="Tabs">
      <div className="bg-[hsl(var(--bg-surface))] p-4 rounded-v2-m border border-[hsl(var(--border-subtle))]">
            ...
            <TableBody>
              {rows.map((r) => (
                <TableRow key={r.id} interactive>
                  <TableCell className="font-medium text-[hsl(var(--text-title))]">{r.name}</TableCell>
...
function CommandSection({
  ...
  return (
    <Section num={14} title="Command palette (⌘K)">
      <div className="space-y-3 bg-[hsl(var(--bg-surface))] p-4 rounded-v2-m border border-[hsl(var(--border-subtle))]">
        ...
        <Command className="rounded-v2-m border border-[hsl(var(--border-subtle))] max-w-lg">
