    ...
    <div className="p-6 max-w-5xl mx-auto print:p-4 print:max-w-none">
      <header className="flex items-start justify-between gap-4 mb-6 print:mb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-[hsl(var(--text-title))]">
      ...
      {state === "ready" && prepKit && (
        <div className="grid gap-4">
          ...
          <Card variant="default" size="md">
            ...
            <p className="mt-2 whitespace-pre-wrap text-[hsl(var(--text-body))] leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 print:grid-cols-2">
            <Card variant="default" size="md">
              ...
              <ul className="mt-2 space-y-1 list-disc list-inside text-[hsl(var(--text-body))]">
          ...
          <Card variant="default" size="md">
            ...
            <p className="mt-2 text-[hsl(var(--text-body))] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-[hsl(var(--text-title))] mb-3">
            ...
            {suggested.length > 0 && (
              <>
                <h3 className="text-sm font-semibold text-[hsl(var(--text-muted))] uppercase tracking-wide mb-2 print:mt-4">
          ...
          <div className="flex items-center gap-2 text-xs text-[hsl(var(--text-muted))] mt-4 print:hidden">
