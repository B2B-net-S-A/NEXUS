...
function TacDlMatrix({ rows }: { rows: DlWithTacsRow[] }) {
 ...
 <td colSpan={2} className="px-3 py-2 text-muted-foreground text-xs italic">
 ...
 className="px-3 py-2 font-semibold text-foreground align-top border-r border-border"
 >
 {row.delivery_lead.name}
 </td>
 )}
