...
const ROLE_ROUTES: RouteAccessRule[] = [
  ...
  // Praktykanci (0373). `/trainee` = lista telefonów TEGO praktykanta — nawet
...
const PUBLIC_PATHS = [
  ...
  // Praktykanci (0373): `/preview/trainee` pokrywa też `/preview/trainees`.
  "/preview/trainee",
...
/**
 * Trasy dostępne dla praktykanta (0373). Wszystko inne przekierowuje na jego
