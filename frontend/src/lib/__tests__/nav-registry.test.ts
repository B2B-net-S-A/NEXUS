...
/** Role z menu — praktykant (0372) ma własną powłokę bez nawigacji. */
...
describe("menu (szyna + „Więcej”, sekcjami) — pozycje per rola identyczne jak przed refaktorem", () => {
  ...
  // Panel „Praktykanci” (0372) — tylko admin i Head of Recruitment.
  ...
  const EXPECTED: Partial<Record<UserRole, string[]>> = {
    ...
    // Praktykant (0372): jeden ekran, bez menu — nawet bez Pomocy i Ustawień.
    trainee: [],
  };
