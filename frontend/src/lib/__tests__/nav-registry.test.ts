...
/** Role z menu — praktykant (0371) ma własną powłokę bez nawigacji. */
...
describe("menu (szyna + „Więcej”, sekcjami) — pozycje per rola identyczne jak przed refaktorem", () => {
  ...
  // Panel „Praktykanci” (0371) — tylko admin i Head of Recruitment.
  ...
  const EXPECTED: Partial<Record<UserRole, string[]>> = {
    ...
    // Praktykant (0371): jeden ekran, bez menu — nawet bez Pomocy i Ustawień.
    trainee: [],
  };
