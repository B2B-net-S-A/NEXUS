...
> = {
  ...
  // „Telefony na dziś” — wyłącznie praktykant (0373), nawet admin nie.
  "nav.trainee": {
    admin: false,
    head_of_recruitment: false,
    delivery_lead: false,
...
/** Praktykant (0373) ma jedną capability: własną listę telefonów. */
...
/**
 * Role z sidebarem. Praktykant (0373) ma własną powłokę bez menu, więc nie
...
const SIDEBAR_HREF_CAPABILITY: Record<string, Capability> = {
  ...
  "/finance": "nav.finance",
  // Panel „Praktykanci” (0373) — w „Więcej” → Codzienna praca.
