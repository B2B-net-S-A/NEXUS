...
/**
 * „Rozwiązanie umowy" z okna „Zakończ współpracę" (0355). Komplet albo nic —
...
export interface B2BGeneratedListParams {
  ...
  /** Tryb rozwiązania umowy — filtr „Zakończonych umów" (0355). */
...
export interface B2BStatusEvent {
  ...
  created_at: string | null;
  /** Zmiana wykonana przez zakończenie kontraktu (0355): kontrakt, koniec
...
export interface B2BGeneratedContractRow {
  ...
  closure_reason_other: string | null;
  closure_date: string | null;
  /** 0355: zakończenie przeniesione z Kontraktów — „Tryb" i „Data zakończenia
