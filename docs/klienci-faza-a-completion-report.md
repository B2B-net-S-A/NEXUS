...
| BE pytest (docker, alembic heads) | PR1: `test_dl_portal` 15/15, `test_reaudit_backend_guards` 11/11, `test_ci_coverage_contract` 3/3; PR2: `test_client_update` 3/3 (nowy), `test_client_directory` 18/18 |
| Deploy + smoke UI | _uzupełnione po merge/deploy — patrz sekcja niżej_ |
