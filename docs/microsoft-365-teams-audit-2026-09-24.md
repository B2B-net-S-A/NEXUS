...
| Zaproszenia Outlook/Teams | Ścieżka kodowa działa przez `POST /me/events`, z opcjonalnym `isOnlineMeeting=true`, `teamsForBusiness`; interfejs „Zaplanuj” używa tej trasy | Funkcja istnieje dla połączonego organizatora. Rzeczywistego utworzenia i doręczenia zaproszenia dziś nie sprawdzono. |
