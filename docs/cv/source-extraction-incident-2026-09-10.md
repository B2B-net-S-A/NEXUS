...
Walidacja przed CI: 145 testów host-native, w tym oba formaty dowodów, niepoprawne zakresy, daty w kolumnach, podziały słów, ograniczenie liczby prób, wspólny budżet czasu, odrzucanie zmyślonych kompetencji i zachowanie końcowej kontroli. Nie używano lokalnego Dockera. Odbiór produkcyjny pozostaje otwarty do faktycznego utworzenia i sprawdzenia dokumentu; wynik jest aktualizowany w PR.
