2026-05-08 18:53:53,110 [INFO] httpx: HTTP Request: POST http://qdrant:6333/collections/nexus_jobs/points "HTTP/1.1 200 OK"
2026-05-08 18:53:53,114 [INFO] httpx: HTTP Request: POST http://qdrant:6333/collections/nexus_jobs/points/search "HTTP/1.1 200 OK"
2026-05-08 18:53:53,183 [INFO] eval_matching: Report written to /tmp/eval-final2.md
# Matching Quality Audit — Phase 0

Generated at: `2026-05-08T18:53:53.182588+00:00`

## Data quality snapshot

- Jobs: 3840 total; **missing must_skills**: 3384 (88%); missing nice_skills: 3837 (100%)
...
|---|:---:|---:|---:|---:|---:|---:|---:|
| `default_40_30_15_10_5` |  | 30 | 0.160 | 0.182 | 0.337 | 0.203 | 0.057 |
...
- **88% jobs lack `must_skills`** — skills layer short-circuits to max for these jobs (see `_score_skills` line 150). Run `POST /api/jobs/{id}/refresh-criteria` or a one-time backfill so skills layer can differentiate candidates.
...
| 1391 | PEP4917_Solution Delivery_Senior Analyst_Replacement of Alek | 61 | 200 | 0.00 | 0.00 | 0.04 | 0.00 |
...
| 1394 | Senior UX/UI Designer (ITVM-6228) | 36 | 200 | 0.00 | 0.06 | 0.08 | 0.00 |
| 1395 | Nordea: PL_Senior- expert _IT Analyst for Data Product Hub-  | 27 | 200 | 0.00 | 0.04 | 0.08 | 0.00 |
...
| 1398 | Tester manualny (ZOB-2627) | 15 | 200 | 0.00 | 0.00 | 0.02 | 0.00 |
...
| 1402 | 1 X Senior Power Platform Developer (41788) | 22 | 200 | 0.20 | 0.14 | 0.25 | 0.09 |
| 1403 | 1 X Data engineer to support building our Metadata Dataprodu | 41 | 200 | 0.00 | 0.00 | 0.04 | 0.00 |
...
| 1408 | Nordea: AM Consultant with Mainframe and Midrange knowledge  | 8 | 200 | 0.20 | 0.12 | 0.33 | 0.08 |
| 1409 | PKO BP: Analityk Systemowy (middle) ZOB-2632 | 26 | 200 | 0.00 | 0.04 | 0.07 | 0.00 |
| 1410 | Nordea: Senior Test Automation Engineer D&A Hub (41806) | 32 | 200 | 0.00 | 0.03 | 0.11 | 0.07 |
