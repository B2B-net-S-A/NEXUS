2026-05-10 22:17:57,377 [INFO] httpx: HTTP Request: POST http://qdrant:6333/collections/nexus_jobs/points/search "HTTP/1.1 200 OK"
2026-05-10 22:17:57,435 [INFO] eval_matching: Report written to /tmp/eval-FINAL-CV.md
# Matching Quality Audit — Phase 0

Generated at: `2026-05-10T22:17:57.434887+00:00`

## Data quality snapshot

- Jobs: 3849 total; **missing must_skills**: 250 (6%); missing nice_skills: 3451 (90%)
- Candidate skills JSONB format: list-of-dict/str = 35470, dict (`technologies`/`stack`) = 20, null = 10650 (total=46445)
...
|---|:---:|---:|---:|---:|---:|---:|---:|
| `default_40_30_15_10_5` |  | 30 | 0.167 | 0.151 | 0.339 | 0.171 | 0.080 |
...
| 2 | Java Backend Developer | 8 | 200 | 1.00 | 0.62 | 1.00 | 0.80 |
...
| 6 | React Frontend Developer | 3 | 200 | 0.00 | 0.00 | 0.00 | 0.00 |
| 7 | Scrum Master / Agile Coach | 4 | 200 | 0.40 | 0.50 | 1.00 | 0.26 |
| 13 | Data Engineer | 3 | 200 | 0.40 | 0.67 | 1.00 | 0.59 |
| 1391 | PEP4917_Solution Delivery_Senior Analyst_Replacement of Alek | 61 | 200 | 0.20 | 0.02 | 0.20 | 0.04 |
...
| 1394 | Senior UX/UI Designer (ITVM-6228) | 36 | 200 | 0.20 | 0.08 | 0.33 | 0.07 |
| 1395 | Nordea: PL_Senior- expert _IT Analyst for Data Product Hub-  | 28 | 200 | 0.00 | 0.00 | 0.05 | 0.00 |
| 1396 | PKO BP Programista Python (middle) ZOB-2613 | 10 | 200 | 0.00 | 0.00 | 0.02 | 0.00 |
...
| 1402 | 1 X Senior Power Platform Developer (41788) | 23 | 200 | 0.40 | 0.22 | 0.33 | 0.20 |
| 1403 | 1 X Data engineer to support building our Metadata Dataprodu | 41 | 200 | 0.00 | 0.02 | 0.07 | 0.00 |
...
| 1408 | Nordea: AM Consultant with Mainframe and Midrange knowledge  | 8 | 200 | 0.20 | 0.12 | 1.00 | 0.33 |
| 1409 | PKO BP: Analityk Systemowy (middle) ZOB-2632 | 26 | 200 | 0.00 | 0.00 | 0.04 | 0.00 |
| 1410 | Nordea: Senior Test Automation Engineer D&A Hub (41806) | 33 | 200 | 0.00 | 0.03 | 0.07 | 0.00 |
...
- **Job 6 — React Frontend Developer** — GT=3, R@20=0.00, missed=[16, 29, 6]
...
- **Job 1395 — Nordea: PL_Senior- expert _IT Analyst for Data Product Hub- replacement (41719)** — GT=28, R@20=0.00, missed=[31874, 20228, 67721, 65940, 66851] ...
