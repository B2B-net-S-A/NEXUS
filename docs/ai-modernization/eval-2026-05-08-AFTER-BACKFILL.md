2026-05-08 19:28:43,708 [INFO] httpx: HTTP Request: POST https://api.voyageai.com/v1/embeddings "HTTP/1.1 200 OK"
2026-05-08 19:28:44,504 [INFO] httpx: HTTP Request: PUT http://qdrant:6333/collections/nexus_jobs/points?wait=true "HTTP/1.1 200 OK"
2026-05-08 19:28:44,505 [INFO] reembed_collections: [reembed jobs] DONE 3840/3840 (ok=3840, fail=0)
2026-05-08 19:29:09,512 [INFO] httpx: HTTP Request: POST http://qdrant:6333/collections/nexus_jobs/points "HTTP/1.1 200 OK"
2026-05-08 19:29:09,516 [INFO] httpx: HTTP Request: POST http://qdrant:6333/collections/nexus_jobs/points/search "HTTP/1.1 200 OK"
2026-05-08 19:29:09,679 [INFO] eval_matching: Report written to /tmp/eval-after-backfill.md
# Matching Quality Audit — Phase 0

Generated at: `2026-05-08T19:29:09.678701+00:00`

## Data quality snapshot

- Jobs: 3840 total; **missing must_skills**: 1666 (43%); missing nice_skills: 3837 (100%)
...
|---|:---:|---:|---:|---:|---:|---:|---:|
| `default_40_30_15_10_5` |  | 30 | 0.160 | 0.176 | 0.348 | 0.203 | 0.083 |
...
- **43% jobs lack `must_skills`** — skills layer short-circuits to max for these jobs (see `_score_skills` line 150). Run `POST /api/jobs/{id}/refresh-criteria` or a one-time backfill so skills layer can differentiate candidates.
