...
**Recruiterem za obowiązkowym onboardingiem** (`UserRole.recruiter`,
`profile_completed=false`) i pozostają niezweryfikowane do kliknięcia linku
aktywacyjnego. Legacy `UserRole.user` jest wycofywany przez migrację 0210 i nie
może być już nadawany. Pełny opis pierwotnego mechanizmu:
